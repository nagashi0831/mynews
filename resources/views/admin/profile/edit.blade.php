        ...
        <div class="col-md-8 mx-auto">
            ...
            ="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control" name="name" value="{{ $profile_form
                        ->name }}">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <textarea class="form-control" name="hobby" row="20">
                        "{{ $profile_form->hobby }}"
                        </textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-2" for="introduction">
                        自己紹介欄(introduction)
                    </label>
                    <div class="col-md-10">
            ...
            <div class="row mt-5">
                <div class="col-md-4 mx-auto">
                    ...
                    <ul class="list-group">
                        ...
                        @foreach ($profile_form->histories2 as $histroy)
